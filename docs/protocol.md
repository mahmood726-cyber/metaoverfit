        # Metaoverfit: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metaoverfit.git

        ## Objective

        MetaOverfit provides diagnostic tools for detecting and correcting overfitting in meta-regression, including permutation testing and bootstrap validation.
        ...
        - Code: https://github.com/mahmood726-cyber/metaoverfit.git
